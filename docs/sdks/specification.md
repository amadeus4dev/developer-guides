...
#### Step 2. Creating the Ruby SDK for the City Search API
...
#### Step 3. Enabling usage of the Ruby SDK for the City Search API
...
#### Step 3. Customising the Ruby SDK for the City Search API
...
#### Step 4. Integrating the Ruby SDK for the City Search API with other libraries
